// Mandolin Chord Data
// Mandolin has 4 courses of paired strings (8 strings total), played/fingered as 4 — diagrams show 4 positions.
// Tuning: G-D-A-E (same pitches as violin, but fretted)
...
export const MANDOLIN_CHORD_ROOTS = ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B']
export const MANDOLIN_CHORD_TYPES = ['Major', 'Minor', '7', 'maj7', 'm7', 'sus2', 'sus4', '6', 'm6', 'add9', 'dim', 'aug', '9']
...
export function getMandolinChordBySlug(slug) {
  return MANDOLIN_CHORDS.find(c => c.name.toLowerCase() === slug.toLowerCase())
}

export function getMandolinChordsForRoot(root) {
  return MANDOLIN_CHORDS.filter(c => c.root === root)
}
