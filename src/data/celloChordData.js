// Cello Chord Data
// Cello is a fretless bowed instrument. These shapes are approximations treated as fretted
// positions for diagram purposes — useful as positional reference for double-stops and chord-like shapes.
// Tuning: C-G-D-A (in fifths, like violin/mandolin but a fifth lower)
// String order in arrays: [C, G, D, A]  (index 0 = C string lowest/thickest, index 3 = A string highest)
//
...
export const CELLO_CHORD_ROOTS = ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B']
export const CELLO_CHORD_TYPES = ['Major', 'Minor', '7', 'maj7', 'm7', 'sus2', 'sus4', '6', 'm6', 'add9', 'dim', 'aug', '9']

export const CELLO_CHORDS = [
  ...
  { name: 'C#add9',  fullName: 'C# Add 9',           root: 'C#', type: 'add9', baseFret: 1, frets: [1, 3, 4, 3], fingers: [1, 2, 4, 2] },
  ...
  { name: 'D#maj7',  fullName: 'D# Major 7th',        root: 'D#', type: 'maj7', baseFret: 1, frets: [3, 1, 3, 3], fingers: [2, 1, 3, 4] },
...
export function getCelloChordBySlug(slug) {
  return CELLO_CHORDS.find(c => c.name.toLowerCase() === slug.toLowerCase())
}

export function getCelloChordsForRoot(root) {
  return CELLO_CHORDS.filter(c => c.root === root)
}
